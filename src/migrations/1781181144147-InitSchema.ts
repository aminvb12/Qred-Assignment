...
export class InitSchema1781181144147 implements MigrationInterface {
    name = 'InitSchema1781181144147'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."cards_status_enum" AS ENUM('active', 'inactive', 'blocked')`);
        await queryRunner.query(`CREATE TABLE "cards" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "card_number" character varying NOT NULL, "issue_date" date NOT NULL, "exp_date" date NOT NULL, "max_credit" numeric(12,2) NOT NULL, "status" "public"."cards_status_enum" NOT NULL DEFAULT 'inactive', "company_id" uuid NOT NULL, CONSTRAINT "UQ_7eaa552a6443b09c5033ebce5e6" UNIQUE ("card_number"), CONSTRAINT "PK_5f3269634705fdff4a9935860fc" PRIMARY KEY ("id"))`);
